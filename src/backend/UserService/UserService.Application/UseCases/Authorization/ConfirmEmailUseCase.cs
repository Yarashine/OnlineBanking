...
public class ConfirmEmailUseCase(UserManager<User> userManager) : IConfirmEmailUseCase
{
    public async Task ExecuteAsync(string userId, string token, CancellationToken cancellation)
    {
